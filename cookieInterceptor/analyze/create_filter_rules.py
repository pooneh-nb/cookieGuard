...
def main():
    filterlist_dir = Path.home().joinpath(Path.cwd(), "filterlists/data/filterlists")
    filterrule_dir = Path.home().joinpath(Path.cwd(), "filterlists/data/filterlist_rules.pkl")
    #     Function to download the filter lists used for labelling.
    ...
    # utilities.write_full_file(filterrule_dir, filterlist_rules)
    with open(filterrule_dir, "wb") as f:
        pickle.dump(filterlist_rules, f)
        f.close
